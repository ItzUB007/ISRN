...
@Component({
  ...
  styleUrls: ['./newletters.component.scss' , '../annual-reports/annual-reports.component.scss']
})
export class NewlettersComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.db.getCompendium().subscribe((data:any)=>{
      ...
      this.newsletters.forEach((data:any)=>{
        data.currentPage = 1;
      })
